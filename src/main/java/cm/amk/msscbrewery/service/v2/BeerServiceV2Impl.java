package cm.amk.msscbrewery.service.v2;

import cm.amk.msscbrewery.web.model.v2.BeerDtoV2;
import cm.amk.msscbrewery.web.model.v2.BeerStyleEnum;
...
public class BeerServiceV2Impl implements BeerServiceV2 {
    ...
    public BeerDtoV2 getBeerById(UUID beerId) {
        return BeerDtoV2.builder().id(UUID.randomUUID())
                .beerName("Galaxy Cat")
                .beerStyle(BeerStyleEnum.PISLNER)
                .build();
    }
    ...
    public void updateBeer(UUID beerId, BeerDtoV2 beerDtoV2) {
        BeerDtoV2.builder().id(beerId).build();
    }
